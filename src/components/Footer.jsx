...
const Footer = () => {
    return (
        <footer className="footer bg-base-300 shadow-sm text-neutral-content px-6 py-3 fixed bottom-0 w-full">
            <div className="flex w-full items-center justify-between flex-wrap gap-4">
                ...
                <aside className="flex items-center gap-2 text-sm">
                    ...
                    <span>
                        © {new Date().getFullYear()} DevConnects (formerly DevTinder). All rights reserved
                    </span>
                </aside>

                {/* CENTER: LEGAL LINKS (INLINE) */}
